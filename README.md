...
U-Boot for Kiwi (IPQ95xx) based boards
...
cd Caraboot-ipq/
git checkout 8dev/kiwi
./build.sh BOARD_NAME  #valid BOARD_NAMEs: kiwi
```
...
The bootloader binary will be saved to ```u-boot-kiwi.mbn```. Use this file to upgrade bootloader on your board.
